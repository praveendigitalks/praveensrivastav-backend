...
import {
  generatePassword,
  generateUsername,
} from "../utils/autogeneratepassword.js";
...
export const getLoggeduserdevcies = async (id, tenantId) => {
  return await User.findById({ _id: id, tenantId }).select("devices userName");
};
